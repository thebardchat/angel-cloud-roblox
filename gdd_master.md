...
1. **Free players get the full game.** Every layer, trial, ability, and Lore Fragment is free.
1. **No loot boxes.** Players know exactly what they’re buying.
1. **No artificial scarcity pressure.** Items don’t disappear or create FOMO.
1. **No child-targeted dark patterns.** No “Are you sure you don’t want this?” popups.
...
|File                    |Purpose                                              |
|------------------------|-----------------------------------------------------|
|`gdd_master.md`         |This document                                        |
|`halo_economy.md`       |Detailed currency balance, sink/faucet analysis      |
|`wing_progression.md`   |Wing tier system, cosmetic skins, unlock requirements|
|`wellness_mechanics.md` |Full mapping of therapeutic concepts → game mechanics|
|`easter_eggs_tracker.md`|All hidden content, locations, triggers, rewards     |
|`luau_style_guide.md`   |Code standards, naming conventions, module patterns  |
|`safety_compliance.md`  |COPPA/CARU checklist, moderation systems             |
|`launch_roadmap.md`     |Detailed phased timeline with milestones             |
